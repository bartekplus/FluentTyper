...
export const CMD_CONTENT_SCRIPT_PERSONALIZATION_EVENT = "CMD_CONTENT_SCRIPT_PERSONALIZATION_EVENT";
...
export const CMD_OPTIONS_CLEAR_PERSONALIZATION = "CMD_OPTIONS_CLEAR_PERSONALIZATION";
