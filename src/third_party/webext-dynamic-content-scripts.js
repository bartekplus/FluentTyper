(function () {
  ...
  function _getManifestPermissionsSync(manifest) {
    ...
    const list = new Set([
      ...
      ...((_b = manifest.content_scripts) !== null && _b !== void 0
        ? _b
        : []
      ).flatMap((config) => {
        let _a;
    ...
    if (
      ...
      !((_c = manifest.optional_permissions) === null || _c === void 0
        ? void 0
        : _c.includes("devtools"))
    ) {
      list.add("devtools");
    }
  ...
  function _getAdditionalPermissions(
    ...
    for (const origin of (_a = currentPermissions.origins) !== null &&
    _a !== void 0
      ? _a
      : []) {
      ...
      if (!strictOrigins) {
        ...
        const isDomainInManifest = manifestPermissions.origins.some(
          (manifestOrigin) => parseDomain(manifestOrigin) === domain
        );
    ...
    for (const permission of (_b = currentPermissions.permissions) !== null &&
    _b !== void 0
      ? _b
      : []) {
      ...
      (_b =
        (_a =
          globalThis === null || globalThis === void 0
            ? void 0
            : globalThis.browser) === null || _a === void 0
          ? void 0
          : _a.contentScripts) === null || _b === void 0
        ? void 0
        : _b.register) !== null && _c !== void 0
      ? _c
      : registerContentScript$1;
